...
def save_depth():
    ...
    with torch.no_grad():
        for batch_idx, sample in enumerate(TestImgLoader):
            ...
            for filename, depth_est, photometric_confidence,refined_edge in zip(filenames, outputs["refined_depth"]['stage_0'],
...
if __name__ == '__main__':
    ...
    for scan in scans:
        ...
        filter_depth(scan_folder, out_folder, os.path.join(args.outdir, 'DDLMVS{:0>3}_l3.ply'.format(scan_id)),
